...
async function getData() {
    ...
    /* The first thing you notice is that the fuction has a async in front of it. 
       ...
       to wait for what every the await is attached to to finish and then it will continue.
       If you ran this you will have to wait 4 sec for beacue the compiler is waiting due to the await 
       in front of taco. */
